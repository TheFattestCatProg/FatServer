...
### Моды на сервере, добавленные по предложению
| Название              | Версия  | Для чего                                             | Дата           | Предложил   |
| :-------------------- | :-----: | :--------------------------------------------------- | :------------: | :---------: |
| Invisible Item Frames | 2       | Создание невидимых рамок                             | 25.12.24 17:35 | Рома Климов |
